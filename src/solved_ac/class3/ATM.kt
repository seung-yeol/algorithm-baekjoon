 ...
 *
 * @see <a href="https://www.acmicpc.net/problem/11399">ATM</a>
 * */
fun main() {
    val bufferedReader = System.`in`.bufferedReader()
    bufferedReader.readLine()
    val queue = bufferedReader.readLine().split(" ").map(String::toInt)

    queue.sorted().runningReduce { acc, new -> acc + new }.sum().let(::println)
}
