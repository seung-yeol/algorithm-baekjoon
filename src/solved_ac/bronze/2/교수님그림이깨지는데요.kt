 ...
 *
 * @see <a href="https://www.acmicpc.net/problem/20205">교수님 그림이 깨지는데요?</a>
 * @see <img src="https://upload.acmicpc.net/473b24e6-9cbd-498a-a653-bcfb27c6bb31/-/preview/">그림 1</>
 * @see <img src="https://upload.acmicpc.net/a170eb35-16a1-4e0e-be7b-fb9d9febdc0f/-/preview/">그림 2</>
 * */
fun main() {
    ...
    repeat(n) { y ->
        ...
        val result = line.joinToString(" ") { number ->
            (0 until k).joinToString(" ") { number }
        }
        for (i in 0 until k) stringBuilder.appendLine(result)
    }
