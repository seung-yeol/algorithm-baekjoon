 ...
 * - 각 숫자는 최소 한 개, 최대 여덟 개의 문어 숫자 기호로 이루어져있다. 입력으로 '#'이 들어오면 입력을 종료한다.
 *
 * **출력**
 * - 입력 받은 문어 숫자에 대응하는 십진수를 한 줄에 하나씩 출력한다.
 *
 * @see <a href="https://www.acmicpc.net/problem/1864">문어 숫자</a>
 * */

/**
 * @see <a href="1864">문어 숫자</a>
 * */
fun main() {
    ...
    while (true) {
        ...
        input.reversed().forEachIndexed { index, char ->
            ...
            result += value * 8.0.pow(index.toDouble()).toInt()
        }
