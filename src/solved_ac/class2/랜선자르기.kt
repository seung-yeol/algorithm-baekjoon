...
/**
 * @see <a href="https://www.acmicpc.net/problem/1654">랜선 자르기</a>
 *
...
fun main() {
    ...
    var sum = 0L
    repeat(size) { index -> array[index] = scanner.nextInt().also { sum += it } }

    var length = sum / required
    var count = 0L
